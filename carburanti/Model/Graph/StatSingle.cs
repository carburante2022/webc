...
public class StatSingle
{
    ...
    internal void Calcola(KeyValuePair<DateOnlyCustom, PrezziGiorno> i10)
    {
        ...
        if (valuePrezzi != null)
            foreach (var i2 in valuePrezzi.Where(i2 =>
                         string.IsNullOrEmpty(i2.descCarburante) == false && i2.isSelf != null))
            {
                ...
                if (i2.isSelf != null && i2.descCarburante != null &&
                    !itemsGrouped[i2.descCarburante].ContainsKey(i2.isSelf.Value))
